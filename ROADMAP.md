> A29 NOTE v2166A29
> Salvage wreck POIs now route into isolated derelict station instances with direct tile module rendering.
> Coupling is immediate to TileForge samples inside the instance path only; overworld generator remains untouched.


> RECOVERY NOTE v2166A28
> Main game baseline restored to A23A-derived safe master.
> Future derelict/wreck/station interiors must be built as isolated dungeon instances.
> No further global overworld/tile hybridization allowed until instance loop is proven playable.
